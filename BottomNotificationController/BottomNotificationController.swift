...
open class BottomNotificationController {
  ...
  open func deliver<T>(notification: NotificationContext<T>, animator: NotificationAnimatorType) where T: NotificationViewType, T: UIView {
  ...
  fileprivate class NotificationViewController: UIViewController {
    ...
    func addNotificationView<T>(notificationView: T, animator: NotificationAnimatorType, completion: @escaping (T) -> Void) where T: NotificationViewType, T: UIView {
    ...
    func removeNotificationView<T>(notificationView: T, animator: NotificationAnimatorType, completion: @escaping (T) -> Void) where T: NotificationViewType, T: UIView {

      removeNotificationViewClosure(notificationView: notificationView, animator: animator, completion: completion)()
    }

    fileprivate func removeNotificationViewClosure<T>(notificationView: T, animator: NotificationAnimatorType, completion: @escaping (T) -> Void) -> () -> Void where T: NotificationViewType, T: UIView {
